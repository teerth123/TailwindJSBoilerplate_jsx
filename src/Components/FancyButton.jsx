...
import { cn } from "../lib/utils"; // Adjusted path as per your update

// Define gradient button variants
...
const GradientButtonBase = React.forwardRef(
...
// Wrapper component to handle styles
const GradientButton = (props) => {
  ...
  return <GradientButtonBase {...props} />;
};
